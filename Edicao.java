...
public class Edicao {
	...
	public static void main(String[] args) {
		...
		String[] tipos = { "Manual de Operação", "Procedimento de Segurança", "Manutenção e Reparos",
				"Testes e Diagnóstico", "Manual de Conduta e Operações Setoriais" };

		String[] tipoOrientacao = new String[15];
							...
							do {
								...
								if (resposta == 'S' || resposta == 's') {
									...
									while (!tipoValido) {
										...
										leia.nextLine();
										if (tipoIndex >= 1 && tipoIndex <= tipos.length) {
											tipoOrientacao[i] = tipos[tipoIndex - 1];
											tipoValido = true;
										} else {
