...
public class proojeto {
	...
	public static void main(String[] args) {
		  Scanner scanner = new Scanner(System.in);
	        ...
	        String tituloMensagem, tipoMensagem, conteudoMensagem, opcaoMenuMensagem, bemvindoMensagem;
	        ...
	        if (opcaoMenu == 1) {
	            ...
	            System.out.print("\n" + conteudoMensagem + idioma );
	            String conteudoPT = scanner.nextLine();
